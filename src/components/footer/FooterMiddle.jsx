...
const FooterMiddle = () => {
  ...
  return (
    <div className='w-full md:pt-20 py-10 px-4 bg-amazon_light'>
      ...
      <div className=' max-w-screen-xl m-auto flex-wrap flex items-start justify-center md:gap-20 text-white'>
        {
          middleFooterData && middleFooterData.map((item) => {
            return (
              <div key={nanoid()} className='flex flex-col items-start justify-start gap-2 mx-4'>
      ...
      {/* ************** Middle Footer BOTTOM starts here **************** */}
          <div className='flex flex-col md:my-20 m-auto'>
            <div className='flex w-96 items-center justify-between gap-5  m-auto'>
